                    ...
                    <div className="bg-[#0c2d3a] rounded-xl p-6 sm:p-10 shadow-2xl space-y-6 sm:space-y-8">
                        ...
                        <form className="space-y-4 sm:space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="space-y-2">
                                ...
                                <input type="text" className="w-full bg-white rounded px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500 text-sm" required />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[12px] font-bold text-white/80 uppercase">Email <span className="text-red-500">*</span></label>
                                <input type="email" className="w-full bg-white rounded px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500 text-sm" required />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[12px] font-bold text-white/80 uppercase">Phone number <span className="text-red-500">*</span></label>
                                <input type="tel" className="w-full bg-white rounded px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500 text-sm" required />
                            </div>
                            <button type="submit" className="w-full sm:w-auto bg-white text-[#0c2d3a] px-8 py-3 font-bold rounded shadow-lg hover:bg-slate-100 transition-colors uppercase text-[12px]">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
